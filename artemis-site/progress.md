# Artemis II Site Progress

## Status
- [x] Research gathered
- [x] Content architecture planned
- [x] Frontend stack chosen
- [x] Next.js project scaffolded
- [x] Global layout and theme started
- [x] Shared site shell component created
- [x] Home page first pass built
- [x] Crew page built
- [x] Mission page built
- [x] Apollo Legacy page built
...
- [ ] Publish/deployment setup completed
